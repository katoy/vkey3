...
String.prototype.toHankanaCase = function()
{
	...
	m =
	{
		...
		0x30F2:0xFF66, 0x30F3:0xFF9D, 0x30C3:0xFF6F,
                // ｬ ｭ ｮ ｯ: katoy
                0x30E3:0xFF6C, 0x30E5:0xFF6D, 0x30E7:0xFF6E, 0x30C3:0xFF6F,
                // 、。「」: katoy
                0x3001:0xFF64, 0x3002:0xFF61, 0x300C:0xFF62, 0x300D:0xFF63,
                // ゛゜: katoy
...
String.prototype.toZenkanaCase = function()
{
	...
	m =
	{
		...
		0xFF9D:0x30F3, 0xFF9E:0x309B, 0xFF9F:0x309C, 0xFF66:0x30F2,
                // ｬ ｭ ｮ ｯ: katoy
                0xFF6C:0x30E3, 0xFF6D:0x30E5, 0xFF6E:0x30E7, 0xFF6F:0x30C3,
                // 、。「」: katoy
                0xFF64:0x3001, 0xFF61:0x3002, 0xFF62:0x300C, 0xFF63:0x300D
	};
